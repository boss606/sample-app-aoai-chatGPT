"""
Run CourtListener bulk filter (IL family law opinions) and produce IngestibleDocuments.

Downloads bulk data from shared location, filters by Illinois courts and family law terms.
"""
...
COURT_DOMAIN = "ill_supreme"
JURISDICTION = "IL"
STATE_NAME = "illinois"
COURT_MATCHERS = ("ill", "Ill", "Illinois Supreme", "IL Supreme", "Illinois Appellate")
COURT_DISPLAY_NAME = "Illinois Supreme Court"
...
def run_courtlistener_to_json(
    ...
    """
    Download CourtListener bulk data, filter IL family law opinions, return IngestibleDocuments.
    """
    if out_dir is None:
...
if __name__ == "__main__":
    ...
    if docs:
        ...
        state = get_state_config("illinois", root_dir=ROOT_DIR)
