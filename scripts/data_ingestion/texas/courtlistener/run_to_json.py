"""
Run CourtListener bulk filter (TX family law opinions) and produce IngestibleDocuments.

Downloads bulk data from shared location, filters by Texas courts and family law terms.
"""
...
COURT_DOMAIN = "tex_supreme"
JURISDICTION = "TX"
STATE_NAME = "texas"
COURT_MATCHERS = ("tex", "Tex", "Texas Supreme", "TX Supreme", "Texas Appellate")
COURT_DISPLAY_NAME = "Texas Supreme Court"
...
def run_courtlistener_to_json(
    ...
    """
    Download CourtListener bulk data, filter TX family law opinions, return IngestibleDocuments.
    """
    if out_dir is None:
...
if __name__ == "__main__":
    ...
    if docs:
        ...
        state = get_state_config("texas", root_dir=ROOT_DIR)
