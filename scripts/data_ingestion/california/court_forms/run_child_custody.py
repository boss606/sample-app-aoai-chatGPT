"""
Run Child Custody & Visitation forms scraper, produce JSON, save locally and upload to blob.
"""
...
CATEGORY = "child_custody_visitation"
SEARCH_URL = "https://selfhelp.courts.ca.gov/find-forms?query=custody"


def run_child_custody_to_json(out_dir: Path | None = None) -> list[IngestibleDocument]:
...
if __name__ == "__main__":
    ...
    docs = run_child_custody_to_json()
    if docs:
