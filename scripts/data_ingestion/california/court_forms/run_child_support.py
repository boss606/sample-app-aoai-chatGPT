"""
Run Child Support forms scraper, produce JSON, save locally and upload to blob.
"""
...
SEARCH_URL = "https://selfhelp.courts.ca.gov/find-forms?query=child%20support"


def run_child_support_to_json(out_dir: Path | None = None) -> list[IngestibleDocument]:
...
if __name__ == "__main__":
    ...
    docs = run_child_support_to_json()
    if docs:
