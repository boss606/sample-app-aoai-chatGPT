"""
Run Divorce forms scraper, produce JSON, save locally and upload to blob.
"""
...
CATEGORY = "divorce"
SEARCH_URL = "https://selfhelp.courts.ca.gov/find-forms?query=divorce"


def run_divorce_to_json(out_dir: Path | None = None) -> list[IngestibleDocument]:
