"""
Run Parentage forms scraper, produce JSON, save locally and upload to blob.
"""
...
CATEGORY = "parentage"
SEARCH_URL = "https://selfhelp.courts.ca.gov/find-forms?query=parentage"


def run_parentage_to_json(out_dir: Path | None = None) -> list[IngestibleDocument]:
