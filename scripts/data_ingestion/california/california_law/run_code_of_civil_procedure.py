"""
Run Code of Civil Procedure scraper, produce JSON, save locally and upload to blob.
"""
...
from scripts.data_ingestion.california.california_law.scrapers.scrape_code_of_civil_procedure import make_scraper
...
def run_code_of_civil_procedure_to_json(out_dir: Path | None = None) -> list[IngestibleDocument]:
...
if __name__ == "__main__":
    ...
    docs = run_code_of_civil_procedure_to_json()
    if docs:
