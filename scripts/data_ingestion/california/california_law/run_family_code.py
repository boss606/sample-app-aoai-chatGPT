"""
Run Family Code scraper, produce JSON, save locally and upload to blob.
"""
...
from scripts.data_ingestion.california.california_law.scrapers.scrape_family_code import make_scraper
...
def run_family_code_to_json(out_dir: Path | None = None) -> list[IngestibleDocument]:
