"""
Run Evidence Code scraper, produce JSON, save locally and upload to blob.
"""
...
from scripts.data_ingestion.california.california_law.scrapers.scrape_evidence_code import make_scraper
...
def run_evidence_code_to_json(out_dir: Path | None = None) -> list[IngestibleDocument]:
...
if __name__ == "__main__":
    ...
    docs = run_evidence_code_to_json()
    if docs:
