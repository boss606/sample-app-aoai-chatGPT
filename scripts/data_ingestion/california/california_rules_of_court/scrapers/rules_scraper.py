...
Fetches the master listing, downloads Title/Appendix PDFs, extracts text, concatenates.
"""
...
RESERVED = {
    "rule", "rules", "section", "sections", "sec", "art", "article", "articles",
    "appendix", "title", "titles", "chapter", "chapters", "division", "divisions",
    "subdivision", "subdivisions", "subsection", "subsections", "paragraph",
    "paragraphs", "code", "statute", "statutes", "act", "§", "form", "forms",
}
...
class RulesPdfScraper:
    ...
    def parse_pdf_links(self, soup: BeautifulSoup) -> List[Tuple[str, str]]:
        ...
        for a in anchors:
            ...
            li = a.find_parent("li")
            title_text = li.get_text(separator=" ", strip=True) if li else (a.get_text(strip=True) or href)
