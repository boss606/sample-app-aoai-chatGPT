...
"""
Scraper for the California Courts of Appeal using CourtListenerOpinionScraper.
"""
...
SEARCH_URL = (
    "https://www.courtlistener.com/api/rest/v4/search/?type=o&court=calctapp"
...
if __name__ == "__main__":
    ...
    # Execução direta: scrape completo e upload para Azure (LegalDocsStorage)
    paths = run_cal_ctapp(upload=True)
