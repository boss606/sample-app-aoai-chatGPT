...
"""
Scraper for SCOTUS opinions using the reusable CourtListenerOpinionScraper.
"""
...
SEARCH_URL = (
    "https://www.courtlistener.com/api/rest/v4/search/?type=o&court=scotus"
...
AGGREGATE_FILE = OUT_DIR / "scotus_all.txt"
